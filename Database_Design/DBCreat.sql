...
CREATE TABLE IF NOT EXISTS `mydb`.`User` (
  ...
  `Phone_Number_Access` TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Activity` (
  ...
  `Response_ID` INT(9) UNSIGNED ZEROFILL NOT NULL,
  `Range` TINYINT NOT NULL,
  `State` TINYINT NOT NULL,
  PRIMARY KEY (`Activity_ID`),
  INDEX `Activity_Response_ID_idx` (`Response_ID` ASC) VISIBLE,
  CONSTRAINT `Activity_Response_ID`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Club` (
  ...
  `Club_Type` VARCHAR(45) NOT NULL DEFAULT 'Comprehensive',
  `Club_Intro` VARCHAR(200) NULL,
  `Club_Leader` INT(9) UNSIGNED ZEROFILL NOT NULL,
  PRIMARY KEY (`Club_ID`),
...
-- -----------------------------------------------------
-- Table `mydb`.`User_Club`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`User_Club` ;

CREATE TABLE IF NOT EXISTS `mydb`.`User_Club` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Activity_Club`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Activity_Club` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Activity_Club` (
  `Club_ID` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Admin` (
  `Admin_ID` INT(9) UNSIGNED ZEROFILL NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Announcement` (
  ...
  `Club_ID` INT UNSIGNED NOT NULL,
  `Publisher` INT UNSIGNED ZEROFILL NOT NULL,
