...
CREATE TABLE IF NOT EXISTS `mydb`.`User` (
  ...
  `Name_Access` TINYINT NOT NULL,
  `Sex_Access` TINYINT NOT NULL,
  `Born_Access` TINYINT NOT NULL,
  `Major_Access` TINYINT NOT NULL,
  `Address_Access` TINYINT NOT NULL,
  `Communicate_Access` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Apply_To_Studert` (
  ...
  CONSTRAINT `AS_Apply_To`
    FOREIGN KEY (`Apply_To`)
    REFERENCES `mydb`.`Activity_User` (`User_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
